            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                <div class="container px-6 py-8 mx-auto">
                    ...
                    <div class="font-[sans-serif] w-max mx-auto bg-gray-200 border divide-x divide-white flex rounded overflow-hidden">
                        ...
                        <button type="button" id="openBorrowerModal"
                                class="px-5 py-2.5 flex items-center text-[#333] text-sm outline-none hover:bg-gray-300 transition-all">
                    ...
                    <!-- Modal for Borrower Registration -->
                    <div class="fixed inset-0 hidden" id="borrowerModal">
                        <div class="fixed inset-0 bg-black bg-opacity-50 z-40" id="borrowerModalBackdrop"></div>
                        <div class="flex justify-center items-center p-4 w-full h-full">
                            <div class="bg-white rounded-lg shadow-lg w-full max-w-lg p-8 relative z-50">
                                <div class="flex justify-between items-center">
                                    <h3 class="text-lg font-bold">Register Borrower</h3>
                                    <button id="closeBorrowerModal" class="text-gray-400 hover:text-red-600">
                                        <!-- Close icon here -->
                                        <!-- SVG code omitted for brevity -->
                                    </button>
                                </div>

                                <form id="addBorrowerForm" class="space-y-4 mt-4" action="registerBorrower" method="POST">
                                    <div>
                                        <label for="userId" class="block text-sm font-medium text-gray-700">User</label>
                                        <select id="userId" name="userId" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                    ...
                                    <div>
                                        ...
                                        <select id="bookId" name="bookId" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                    ...
                                    <div>
                                        ...
                                        <input type="date" id="borrowDate" name="borrowDate" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                    </div>
                                    <div>
                                        <label for="returnDate" class="block text-sm font-medium text-gray-700">Return Date</label>
                                        <input type="date" id="returnDate" name="returnDate" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                    </div>
                                    <div class="flex justify-end">
                                        <button type="submit" class="mt-5 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Register Borrower</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <script>
                        document.getElementById('openBorrowerModal').addEventListener('click', function() {
                            document.getElementById('borrowerModal').style.display = 'flex';
                        });
                        document.getElementById('closeBorrowerModal').addEventListener('click', function() {
                            document.getElementById('borrowerModal').style.display = 'none';
                        });
                        document.getElementById('borrowerModalBackdrop').addEventListener('click', function() {
                            document.getElementById('borrowerModal').style.display = 'none';
                        });
                    </script>
